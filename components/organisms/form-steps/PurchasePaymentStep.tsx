        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span>Service:</span>
              <span className="font-medium capitalize">Purchase</span>
            </div>
            {selectedContainer && (
              <>
                <div className="flex justify-between">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-blue-800">
              ...
              <p className="mt-1">
                ...
                to confirm details and arrange {deliveryOption === 'delivery' ? 'delivery' : 'collection'}. You'll receive email updates throughout the process.
              </p>
            </div>
          </div>
        </div>
...
export default PurchasePaymentStep
