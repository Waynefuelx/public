  ...
  return (
    <Card className="overflow-hidden group" hover>
      ...
      <div className="p-6 sm:p-8">
        ...
        {/* Action Button */}
        <a
          href="mailto:rental@topshell.co.za?subject=Container Services Quote Request&body=Hi, I would like to request a quote for container services. Please contact me with more information about your services and pricing."
